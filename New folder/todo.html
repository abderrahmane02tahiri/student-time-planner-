    ...
    <header>
      <div class="header-left">
        <button class="header-button menu-button">
          ...
          <span class="tooltip"> fermer le menu </span>
        </button>
        <button
      ...
      <div class="header-right">
        <button class="header-button add-task-button">
          ...
          <span class="tooltip"> Ajouter une Tache </span>
        </button>
        <button class="header-button reset-data-button">
          ...
          <span class="tooltip"> Suprrimer les données </span>
        </button>
      </div>
    </header>
      ...
      <div class="add-task-modal">
        <form id="add-task-form" action="">
          ...
          <div class="extra-fields">
            ...
            <div class="priority-dropdown">
              <div class="priority-selector">
                ...
                <span class="tooltip"> Définir la priorité </span>
              </div>
          ...
          <div class="cancel-submit-container">
            <button class="cancel-button" type="button">Annuler</button>
      ...
      <div class="sidebar">
        <ul>
          <li>
            ...
            >
              ...
              ><span>Inbox</span>
              <span class="tooltip"> Aller à Inbox </span>
            </button>
          </li>
        </ul>
        <div class="sidebar-projects">
          ...
          <button class="add-project-button">
            ...
            <span class="tooltip"> Ajouter un Project </span>
          </button>
        </div>
